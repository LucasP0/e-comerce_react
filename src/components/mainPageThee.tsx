...
export const MainPageThee = () => {
        ...
        <div className='flex flex-col items-start justify-start mt-20'>
          ...
          <div className='max-lg:w-full'>
            ...
            <div className='flex flex-col items-center justify-center w- border-2 border-ff rounded-md  mt-10 p-8 max-lg:w-full'>
              {/* aqui */}
              <div className='flex flex-row items-end  gap-28 max-lg:flex-col max-lg:w-full max-lg:items-center max-lg:gap-2'>
              ...
              <div className='w-full flex flex-col max-lg:items-center pt-2'>
  ...
  {/****** SECTION DADOS DO APARELHO ********* **/}
              <div className='flex flex-row items-end  gap-28 max-lg:flex-col max-lg:w-full max-lg:items-center max-lg:gap-2 max-lg:mt-4'>
                <section className='flex flex-col gap-4'>
                  <h2 className='font-bold text-lg py-2 mt-8 flex flex-row items-center gap-4 max-lg:m-auto '> <Smartphone /> Dados do Aparelho </h2>
                  <div className='w-full flex flex-col max-lg:items-center' >
                    <p className='pb-2 font-light text-sm'>Produto
                    </p>
                    <div>
                      <input type="text" placeholder='Selecionar -' name="email"  className='w-inputmd rounded-md h-boxsx text-black p-2 max-lg:w-full' />
                    </div>
                  </div>
                  <div className='w-full flex flex-col max-lg:items-center' >
              ...
              items-start justify-start  '>
                ...
                <section className='flex flex-row gap-4 max-lg:flex-col'>
