...
export const Sidebar = () => {
  return (
    <header className='bg-white flex flex-col'>
          <nav className=' h-20 flex flex-row gap-7 items-center justify-between p-12 max-lg:w-full max-lg:flex-col max-lg:h-auto max-lg:py-2'>
            <div className='flex flex-row items-center gap-8 max-lg:flex-col w-full '>
            ...
            <div className='flex flex-row items-center gap-14 max-sm:flex-col max-lg:gap-2'>
